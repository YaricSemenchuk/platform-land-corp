        ...
        <Reveal as="div" delay={360}>
          <div className="mt-10 flex justify-center">
            <button
              ...
              className="group inline-flex items-center gap-3 rounded-full border border-black/80 bg-white px-7 py-3.5 text-sm font-semibold text-ink shadow-[0_6px_0_0_#000] transition duration-200 ease-out hover:-translate-y-1 hover:shadow-[0_6px_0_0_#000] active:translate-y-0.5 active:shadow-[0_3px_0_0_#000]"
            >
              Get Started
